...
import {
  ...
  MAX_CHARS,
  useSpeechGenerator,
} from "@/components/useSpeechGenerator";
        ...
        <div className="lg:col-span-2">
          ...
          >
            ...
            <button
              ...
              style={{
                backgroundColor: canGenerate ? "#111111" : "var(--border)",
                color: canGenerate ? "#ffffff" : "var(--text-muted)",
                borderRadius: "4px",
                cursor: canGenerate ? "pointer" : "not-allowed",
              }}
              onMouseEnter={(e) => {
                if (canGenerate) e.currentTarget.style.backgroundColor = "#333333";
              }}
              onMouseLeave={(e) => {
                if (canGenerate) e.currentTarget.style.backgroundColor = "#111111";
              }}
              type="button"
            >
              {loading ? (
