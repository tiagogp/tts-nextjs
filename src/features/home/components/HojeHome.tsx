...
function resolveNextAction({
  ...
  // The skill-balance planner used to answer here, steering the learner by the gap between a
  // fabricated weekly-minutes measurement (1 minute per review, 2 per conversation turn, …)
  // and a target ratio with no basis in any literature. Invented numbers must not decide what
  // a learner does next, so the branch is gone and the observable state below decides.
