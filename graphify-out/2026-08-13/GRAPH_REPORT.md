# Graph Report - text-to-speech  (2026-08-13)

## Corpus Check
- 413 files · ~831,000 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2871 nodes · 7968 edges · 235 communities (126 shown, 109 thin omitted)
...
## Communities (235 total, 109 thin omitted)
...
Cohesion: 0.08
Nodes (40): TabErrorBoundaryProps, TabErrorBoundaryState, TabErrorFallback(), Button, Card(), CardProps, NaturalnessReview(), FeedbackPanel() (+32 more)

### Community 3 - "First-Run Activation"
Cohesion: 0.08
Nodes (55): useDockDueBadge(), clearAll(), count(), countFromIndex(), del(), get(), getAllFromIndex(), getMany() (+47 more)

### Community 4 - "Learn Audio Generation Script"
Cohesion: 0.08
Nodes (35): Chip, Field(), FieldProps, Input, Textarea, ProviderBadge(), ProviderBadgeProps, StatusPill() (+27 more)
...
Cohesion: 0.19
Nodes (11): ProgressData, ProgressInput, NOW, review(), unaidedProductionPair(), AudioRecording, ListeningAttempt, ProductionAttempt (+3 more)
...
Cohesion: 0.13
Nodes (28): NOW, pair(), review(), SessionResult, SessionSummary(), summarize(), line(), makeResult() (+20 more)

### Community 15 - "Ingestion API Routes"
Cohesion: 0.17
Nodes (39): POST(), cardProviderKind(), POST(), conversationProviderKind(), parseTurns(), POST(), POST(), toEnglishLevel() (+31 more)
...
Cohesion: 0.14
Nodes (34): HojeHome(), isProductionAttemptEvent(), NextAction, resolveNextAction(), routeHandler(), WeeklyTransferCard(), WeeklyTransferSuggestion, ReturnMoment (+26 more)
...
Cohesion: 0.15
Nodes (23): CorrectionList(), RetryStep(), CATEGORY_BY_ERROR, countPolishFeedback(), FeedbackCategory, feedbackIssue, FeedbackIssueBase, feedbackKey() (+15 more)
...
Cohesion: 0.20
Nodes (10): ConversationTurn, ConverseOptions, CorrectOptions, GenerationRunOptions, ClaudeProvider, OpenAIProvider, logUsage(), requestOptions() (+2 more)
...
Cohesion: 0.09
Nodes (27): AppHeader(), AppHeaderProps, emptySubscribe(), useIsClient(), AppProviders(), HOME_TABS, HomeTab, useTheme() (+19 more)
...
Cohesion: 0.17
Nodes (18): combinedSignal(), POST(), clamp(), extractLinesFromJson(), normalizeLines(), POST(), PublicRouteError, runtimeErrorMessage() (+10 more)
...
Cohesion: 0.19
Nodes (9): DeckGenerationResult, phraseSource, ollamaBaseUrl(), OllamaProvider, Card, CardSource, Critique, buildCritiqueRequest() (+1 more)

### Community 45 - "Content Discovery Pipeline"
Cohesion: 0.08
Nodes (30): HomeContent(), Overlay, recommendedLessonId(), resolveLessonId(), SpeakTab(), Modal(), PageHeader(), PageHeaderProps (+22 more)
...
Cohesion: 0.24
Nodes (13): buildDeckFromPhrases(), completedLessonIdsFromCardIds(), Lesson, lessonCardIds(), LessonComprehensionQuestion, LessonDialogueLine, LessonMaterial, LessonPhrase (+5 more)

### Community 49 - "Dev Dependencies"
Cohesion: 0.23
Nodes (12): countTaskEvidence(), EvidencePayload, payload(), PlanEvidenceTask, taskEvidenceMeetsTarget(), TodayPlanState, useTodayPlan(), DailyTask (+4 more)
...
Cohesion: 0.13
Nodes (20): comparableAttemptPair(), RecordingComparison(), seconds(), signedDelta(), alignWords(), assessPronunciationText(), clampScore(), CONTRACTIONS (+12 more)
...
Cohesion: 0.05
Nodes (62): generateLevelTest(), gradeLevelWriting(), LevelTestFlow(), LevelTestFlowProps, Stage, AttemptEvaluation, ComprehensionQuestion, evaluateAttempt() (+54 more)
...
Cohesion: 0.11
Nodes (32): BandQueueResult, orderDueQueue(), DueCard, card(), freshCard(), stableCard(), OrderedDueQueue, bandGateMetrics (+24 more)

### Community 63 - "Claude Card Provider"
Cohesion: 0.23
Nodes (4): Embedder, CardGenerationProvider, OpenRouterProvider, AdvancedReview

### Community 64 - "C1 Phase Proposal"
Cohesion: 0.21
Nodes (23): activeDayCount(), avg(), buildMilestones(), clampScore(), computeProgressSnapshot(), confidenceFor(), ConfidenceIndicators, errorTrend() (+15 more)
...
### Community 68 - "linux"
Cohesion: 0.10
Nodes (35): Label(), Notice(), NoticeProps, toneClass, Spinner(), CorrectionListProps, EMPTY_DATA, formatDate() (+27 more)
...
Cohesion: 0.20
Nodes (19): ThemeResponse, ClaudeProviderOptions, OllamaProviderOptions, OpenAIProviderOptions, OpenRouterProviderOptions, extractJson(), UsageLike, DiscoveryRequest (+11 more)
...
Cohesion: 0.12
Nodes (26): POST(), ExportErrorPayload, linesFromText(), parseThemePhraseCount(), timeoutError(), uniquePhrases(), POST(), safeLevel() (+18 more)
...
Cohesion: 0.18
Nodes (13): AdaptationKind, AdaptationSuggestion, evaluateAdaptation(), buildPlanChunkPrompt(), buildPlanSkeletonPrompt(), ChunkContext, learnerBlock(), PlanPromptMeta (+5 more)
...
Cohesion: 0.08
Nodes (37): DueCardLike, endOfTomorrowLocal(), localDayIndex(), mistakeCardStats(), returnMomentFor(), NOW, TWO_DAYS_AGO, WEEK_AGO (+29 more)
...
Cohesion: 0.12
Nodes (26): WorkflowSteps(), WorkflowStepsProps, DeckGeneration, DeckGenerationOptions, GenerationStage, useDeckGeneration(), authoredError(), curateDiscoverSegments() (+18 more)
...
Cohesion: 0.14
Nodes (18): groupRefinementsByDimension(), RegisterGap, refinement(), C1Diagnosis, NaturalnessReviewProps, RetryStepProps, LevelReadinessInput, AdvancedReviewSummary (+10 more)
...
Cohesion: 0.09
Nodes (26): adoptLog(), due(), NOW, NOW_MS, review(), srs(), CycleInputs, CycleOption (+18 more)
...
Cohesion: 0.13
Nodes (19): cancelPlanGeneration(), getPlanJobState(), IDLE, listeners, PlanGenerationRequest, PlanJobState, retryPlanGeneration(), run() (+11 more)
...
Cohesion: 0.40
Nodes (5): computeUnaidedProduction(), isUnaided(), UnaidedProductionStats, ProgressSnapshot, StoredProgressAssessment
...
### Community 128 - "transfer.ts"
Cohesion: 0.47
Nodes (4): buildTransferActivities(), TransferActivity, TransferActivityKind, transferMetrics

### Community 131 - "graphify reference: transcribe video and audio"
Cohesion: 0.40
Nodes (4): framework, installCommand, regions, $schema

### Community 185 - "PhraseLoop Validation Log"
Cohesion: 0.40
...
Cohesion: 0.09
Nodes (29): ADVANCED_CONVERSATION_FLOOR, average(), deriveListeningStage(), deriveReadingWritingStage(), deriveSpeakingStage(), FAMILIAR_TOPICS, FamiliarTopic, FamiliarTopicHistoryItem (+21 more)

### Community 238 - "MistakeStep.tsx"
Cohesion: 0.10
Nodes (50): C1Tab(), useProviderSelection(), sendConversationTurn(), synthesizeSpeech(), ConverseTab(), ConverseTabProps, formatWhen(), RepertoirePanel() (+42 more)
...
## Knowledge Gaps
- **880 isolated node(s):** `eslintConfig`, `nextConfig`, `name`, `version`, `private` (+875 more)
...
- **Why does `useT()` connect `Shared Feature UI Widgets` to `LessonView.tsx`, `Learn Audio Generation Script`, `linux`, `Root TypeScript Config`, `classifyProviderFailure`, `Content Discovery Pipeline`, `MistakeStep.tsx`, `AI Settings API`, `Native Audio Decoding`, `Discover & Provider Selection`, `Study Card Scaffolding`, `SRS Analytics Dashboard`, `Package Dependencies`, `effort.ts`, `Correction Input Forms`?**
