# Graph Report - text-to-speech  (2026-08-14)

## Corpus Check
- 415 files · ~832,470 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2893 nodes · 8032 edges · 230 communities (121 shown, 109 thin omitted)
...
## Communities (230 total, 109 thin omitted)

### Community 0 - "Study Plan Adaptation"
Cohesion: 0.05
Nodes (73): POST(), validEntry, metadata, structuredData, AppMockup(), HeroSection(), HeroSectionProps, InsideSection() (+65 more)

### Community 1 - "Demo Fixture Data"
Cohesion: 0.08
Nodes (39): actionForStage(), activityMinutes(), add(), AREA_LABEL, balanceFor(), DEFAULT_TARGET, deriveMethodPlan(), lastStageAt() (+31 more)

### Community 2 - "Shared Feature UI Widgets"
Cohesion: 0.08
Nodes (46): SpeakTab(), TabErrorBoundaryProps, TabErrorBoundaryState, TabErrorFallback(), Card(), CardProps, Input, evaluateCorrectionText() (+38 more)

### Community 3 - "First-Run Activation"
Cohesion: 0.08
Nodes (57): deletePlan(), AudioRecording, clearAll(), count(), countFromIndex(), del(), get(), getAll() (+49 more)

### Community 4 - "Learn Audio Generation Script"
Cohesion: 0.07
Nodes (38): Field(), FieldProps, Label(), Textarea, Modal(), ProviderBadge(), ProviderBadgeProps, Select() (+30 more)
...
Cohesion: 0.10
Nodes (24): ProgressData, ProgressInput, StoredProgressAssessment, NOW, review(), unaidedProductionPair(), ListeningAttempt, RetryOutcome (+16 more)
...
Cohesion: 0.06
Nodes (51): GOAL_OPTIONS, OnboardingDialog(), subscribe(), isLanguageCode(), isNativeLanguageCode(), isTargetLanguageCode(), Language, languageLabel() (+43 more)

### Community 14 - "Native Audio Decoding"
Cohesion: 0.09
Nodes (45): NOW, pair(), review(), UnaidedProductionStats, SessionResult, SessionSummary(), summarize(), line() (+37 more)

### Community 15 - "Ingestion API Routes"
Cohesion: 0.19
Nodes (35): POST(), POST(), ExportErrorPayload, cardProviderKind(), linesFromText(), parseThemePhraseCount(), uniquePhrases(), POST() (+27 more)
...
Cohesion: 0.25
Nodes (15): useDockDueBadge(), CRITERION_LABEL, ReadinessCoach(), retakeAvailableAt(), refreshMethodProgression(), ProgressOverview(), isStoreAvailable(), countDueCards() (+7 more)
...
Cohesion: 0.09
Nodes (36): ManualEntryFormProps, CORRECTION_ERROR_TYPES, CORRECTION_INPUT_OPTIONS, CorrectionDraft, CorrectionInputMode, ERROR_TYPE_SET, newDraft(), parseErrorsJson() (+28 more)

### Community 22 - "SRS Analytics Dashboard"
Cohesion: 0.18
Nodes (15): CATEGORY_BY_ERROR, FeedbackCategory, feedbackIssue, FeedbackIssueBase, feedbackKey(), FeedbackPriority, FeedbackPriorityOptions, IMPACT_BY_CATEGORY (+7 more)

### Community 23 - "Package Dependencies"
Cohesion: 0.06
Nodes (36): AppProviders(), AudioPlayer(), AudioPlayerProps, isLevelAtLeast(), LEVEL_RANK, CORRECTIONS, MUST_NOT_FIRE, TRANSFER_RULES (+28 more)
...
Cohesion: 0.10
Nodes (24): ButtonProps, buttonVariants, Chip, ChipProps, Disclosure(), DisclosureProps, IconButtonProps, ModalProps (+16 more)
...
Cohesion: 0.09
Nodes (30): buildLevelTestPrompt(), buildWritingGradePrompt(), deterministicCritique(), AdvancedReviewResult, buildMineRequest(), CEFR_LANGUAGE_PROFILE, cefrLanguageLine(), coerceErrorType() (+22 more)
...
Cohesion: 0.10
Nodes (30): PlanGenerationRequest, generatorMock, loadJob(), meta, plan, request, alignBlockDays(), chunkContext() (+22 more)
...
Cohesion: 0.15
Nodes (21): AdaptationKind, AdaptationSuggestion, evaluateAdaptation(), computeAndSaveEffortSnapshot(), computeStreak(), MINUTES_PER_EVENT, plannedMinutesForWeek(), startOfWeek() (+13 more)

### Community 42 - "Card Deck Preview UI"
Cohesion: 0.13
Nodes (22): POST(), safeLevel(), safeSourceKind(), toSegment(), POST(), clamp(), extractLinesFromJson(), normalizeLines() (+14 more)
...
Cohesion: 0.19
Nodes (10): DeckGenerationResult, phraseSource, DeckResult, source, OpenAIProviderOptions, Card, CardSource, Critique (+2 more)

### Community 45 - "Content Discovery Pipeline"
Cohesion: 0.24
Nodes (7): PageHeader(), PageHeaderProps, ConversationTab(), ADVANCED_CONVERSATION_SCENARIOS, CONVERSATION_LEVELS, CONVERSATION_SCENARIOS, ConversationLevel
...
Cohesion: 0.11
Nodes (36): HomeContent(), Overlay, recommendedLessonId(), resolveLessonId(), isProductionAttemptEvent(), NextAction, resolveNextAction(), routeHandler() (+28 more)
...
Cohesion: 0.12
Nodes (16): 1. What this is, 3. Card pipeline — build status, 7. Method implementation status, 8. Design and UX rules, 9. Technical backlog, Active product priority, ✅ Close the loop — ingestion → card → Anki, ✅ Done — foundation (+8 more)
...
Cohesion: 0.07
Nodes (53): EnglishLevel, generateLevelTest(), gradeLevelWriting(), LevelTestFlow(), LevelTestFlowProps, Stage, LocalPlacementCheck(), LocalPlacementCheckProps (+45 more)
...
Cohesion: 0.16
Nodes (17): BandQueueResult, DueCard, OrderedDueQueue, StudySnapshot, BandGateResult, BandVerdict, CardLike, clamp01() (+9 more)

### Community 63 - "Claude Card Provider"
Cohesion: 0.19
Nodes (7): OpenRouterProvider, ContentSource, DiscoveryRequest, TranscriptSegment, request, source, transcript

### Community 64 - "C1 Phase Proposal"
Cohesion: 0.15
Nodes (28): computeUnaidedProduction(), isUnaided(), activeDayCount(), avg(), buildMilestones(), clampScore(), computeProgressSnapshot(), confidenceFor() (+20 more)

### Community 65 - "W5 Validation Protocol"
Cohesion: 0.20
Nodes (4): Embedder, CardGenerationProvider, ClaudeProvider, AdvancedReview

### Community 68 - "linux"
Cohesion: 0.12
Nodes (22): Button, Notice(), NoticeProps, toneClass, Spinner(), AiEvaluateForm(), AiEvaluateFormProps, CorrectionListProps (+14 more)
...
Cohesion: 0.16
Nodes (18): ThemeResponse, CorrectOptions, ClaudeProviderOptions, ollamaBaseUrl(), OllamaProvider, OllamaProviderOptions, OpenRouterProviderOptions, extractJson() (+10 more)
...
Cohesion: 0.10
Nodes (36): computeUnlockedTabTier(), highestNewTab(), TabGates, tabsForUnlockTier(), UnlockSignals, useUnlockedTabs(), HojeHome(), DueCardLike (+28 more)
...
Cohesion: 0.12
Nodes (27): POST(), readCounts(), readRecentDays(), POST(), PLAN_METRIC_ACTIONS, PLAN_TASK_TYPES, GeneratedDay, GeneratedTask (+19 more)
...
Cohesion: 0.07
Nodes (33): comparableAttemptPair(), RecordingComparison(), seconds(), signedDelta(), adoptLog(), due(), NOW, NOW_MS (+25 more)
...
Cohesion: 0.05
Nodes (51): AudioCoverageRule, AudioDelivery, AudioRecordingKind, coverageForBatch(), LessonAudioMetadata, syntheticAudioMetadata(), validateLessonAudioMetadata(), LessonComprehensionKind (+43 more)

### Community 238 - "MistakeStep.tsx"
Cohesion: 0.11
Nodes (42): sendConversationTurn(), synthesizeSpeech(), ConverseTab(), ConverseTabProps, formatWhen(), RepertoirePanel(), ConversationScenario, RepertoireItem (+34 more)
...
## Knowledge Gaps
- **886 isolated node(s):** `eslintConfig`, `nextConfig`, `name`, `version`, `private` (+881 more)
...
- **Why does `useT()` connect `Shared Feature UI Widgets` to `Study Plan Adaptation`, `Progress Scoring Model`, `LessonView.tsx`, `Learn Audio Generation Script`, `linux`, `Root TypeScript Config`, `Content Discovery Pipeline`, `MistakeStep.tsx`, `Learning Rubrics`, `Conversation Providers`, `AI Settings API`, `Discover & Provider Selection`, `Native Audio Decoding`, `Package Dependencies`, `classifyProviderFailure`, `effort.ts`, `Correction Input Forms`?**
