# Graph Report - text-to-speech  (2026-07-11)

## Corpus Check
- 355 files · ~711,888 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2367 nodes · 6226 edges · 223 communities (110 shown, 113 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 122 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9532b571`
...
- App Boundaries and Runtime Shape
...
2. `cn()` - 62 edges
3. `Card` - 56 edges
4. `GenerationRunOptions` - 42 edges
5. `ErrorEvent` - 42 edges
6. `ProviderKind` - 41 edges
7. `useStudySession()` - 35 edges
8. `readJsonObject()` - 31 edges
9. `Card()` - 30 edges
10. `getLearningProfile()` - 29 edges
...
- `HeroSection()` --indirect_call--> `event()`  [INFERRED]
  apps/landing/src/components/features/landing/HeroSection.tsx → src/features/activation/metrics.test.ts
- `LandingFooter()` --indirect_call--> `event()`  [INFERRED]
  apps/landing/src/components/layout/LandingFooter.tsx → src/features/activation/metrics.test.ts
...
## Communities (223 total, 113 thin omitted)

### Community 0 - "Study Plan Adaptation"
Cohesion: 0.11
Nodes (24): PlanTaskRow(), AVAILABILITY_OPTIONS, CALENDAR_STATUS_DOT, CALENDAR_STATUS_RING, MONTH_NAMES, PLAN_DAYS_OPTIONS, PLAN_METRIC_ACTIONS, TASK_COLORS (+16 more)

### Community 1 - "Demo Fixture Data"
Cohesion: 0.16
Nodes (12): DeckGenerationResult, GenerationRunOptions, ClaudeProvider, OpenAIProvider, Card, CardSource, Critique, buildCritiqueRequest() (+4 more)

### Community 2 - "Shared Feature UI Widgets"
Cohesion: 0.11
Nodes (29): Segmented(), SegmentedOption, SegmentedProps, DeckGeneration, DeckGenerationOptions, GenerationStage, useDeckGeneration(), sendConversationTurn() (+21 more)

### Community 3 - "First-Run Activation"
Cohesion: 0.07
Nodes (40): ActivationTiming, FirstRunActivation, FirstRunActivationSource, getStorage(), markFirstRunPhrasesSaved(), markFirstRunReviewCompleted(), read(), startFirstRunActivation() (+32 more)
...
Cohesion: 0.26
Nodes (11): AiSettingsProvider(), AiSettingsValue, bridge(), Context, EMPTY_SETTINGS, AiConnectionState, AiSettingsPatch, AiSettingsSaveResult (+3 more)
...
Cohesion: 0.09
Nodes (46): row(), deletePlan(), getActivityByType(), clearAll(), count(), countFromIndex(), del(), get() (+38 more)

### Community 9 - "Landing Site UI"
Cohesion: 0.13
Nodes (29): SessionResult, ScaffoldControls(), ScaffoldTelemetry, StudyCard(), StudyCardProps, buildHint(), isStable(), recentFailureCount() (+21 more)

### Community 10 - "Home Page Shell"
Cohesion: 0.25
Nodes (11): POST(), PROVIDER_FALLBACK_LABELS, ExportErrorPayload, fallbackThemePhrases(), linesFromText(), parseThemePhraseCount(), uniquePhrases(), GET() (+3 more)
...
Cohesion: 0.14
Nodes (26): activeDayCount(), avg(), buildMilestones(), clampScore(), computeProgressSnapshot(), confidenceFor(), errorTrend(), estimatedBand() (+18 more)

### Community 13 - "AI Settings API"
Cohesion: 0.21
Nodes (19): GET(), GET(), LABELS, PATCH(), POST(), ollamaApiRoot(), getDefaultProvider(), getOllamaBaseUrl() (+11 more)

### Community 14 - "Native Audio Decoding"
Cohesion: 0.12
Nodes (22): ensureKokoroModel(), BRACKETED_NON_SPEECH_RE, collapseWhisperOverlaps(), createAsync(), GeneratedAudio, getTts(), NON_SPEECH_MARKER, normalizeKey() (+14 more)

### Community 15 - "Ingestion API Routes"
Cohesion: 0.26
Nodes (11): clamp(), extractLinesFromJson(), normalizeLines(), POST(), PublicRouteError, runtimeErrorMessage(), safeSpeed(), safeVoice() (+3 more)

### Community 16 - "Local Server Routes"
Cohesion: 0.15
Nodes (33): error(), audioPathFor(), ensureWhisperModel(), kokoroInstalled(), modelStatus, whisperInstalled(), ANY_ROUTES, dispatch() (+25 more)

### Community 17 - "Card API Integration Tests"
Cohesion: 0.09
Nodes (26): ButtonProps, buttonVariants, Chip, ChipProps, Disclosure(), DisclosureProps, IconButton, IconButtonProps (+18 more)

### Community 18 - "Discover & Provider Selection"
Cohesion: 0.12
Nodes (25): Modal(), ProviderBadge(), ProviderBadgeProps, Select(), SelectOption, SelectProps, FlaggedItem, GrammarGap (+17 more)

### Community 19 - "UI Primitives & Motion Tokens"
Cohesion: 0.08
Nodes (55): HomeContent(), Overlay, recommendedLessonId(), resolveLessonId(), HOME_TABS, HomeTab, useDockDueBadge(), computeUnlockedTabTier() (+47 more)

### Community 20 - "W5 Decision-Gate Scorer"
Cohesion: 0.15
Nodes (28): countTrue(), currentPath, formatCount(), formatDuration(), formatPercent(), GATE_DEFS, isSeparatorRow(), isTemplateRow() (+20 more)

### Community 21 - "Plan Generation API"
Cohesion: 0.13
Nodes (21): planProviderKind(), POST(), PLAN_TASK_TYPES, extractJsonObject(), GeneratedDay, GeneratedTask, validateGeneratedDays(), validatePlanResult() (+13 more)

### Community 22 - "SRS Analytics Dashboard"
Cohesion: 0.17
Nodes (12): computeReturnAfterMiss(), dayIndex(), dayKey(), group(), PerformanceStats, productionTrend(), productionTrends(), ReturnAfterMiss (+4 more)
...
Cohesion: 0.13
Nodes (30): RFC-5987, RFC-6266, ApkgErrorPayload, csvEscapeCell(), isProbablyJsonUpload(), isTimeoutOrAbort(), jsonToCsvBytes(), jsonToCsvBytesFromParsed() (+22 more)
...
Cohesion: 0.10
Nodes (26): ThemeResponse, DiscoveryRequest, PhraseCandidate, TranscriptSegment, AdvancedReviewResult, buildMineRequest(), CEFR_LANGUAGE_PROFILE, cefrLanguageLine() (+18 more)

### Community 29 - "SRS Cycle Planner"
Cohesion: 0.09
Nodes (39): GardenData, GardenInput, BandQueueResult, fatigueByCard(), orderDueQueue(), adoptLog(), due(), NOW (+31 more)
...
Cohesion: 0.14
Nodes (26): Field(), FieldProps, Input, Label(), Textarea, Notice(), NoticeProps, toneClass (+18 more)

### Community 34 - "Study Session Modes"
Cohesion: 0.19
Nodes (14): Embedder, abortError(), CardGenerationProvider, debug(), DeckResult, generateDeck(), generateVettedCards(), isAbortError() (+6 more)

### Community 35 - "Provider Selection Constants"
Cohesion: 0.21
Nodes (27): POST(), cardProviderKind(), POST(), safeLevel(), safeSourceKind(), toSegment(), POST(), POST() (+19 more)
...
Cohesion: 0.14
Nodes (21): AdaptationKind, AdaptationSuggestion, evaluateAdaptation(), PlanOnboardingProps, computeAndSaveEffortSnapshot(), computeStreak(), MINUTES_PER_EVENT, plannedMinutesForWeek() (+13 more)
...
Cohesion: 0.15
Nodes (21): ENGLISH_LEVELS, isLanguageCode(), isNativeLanguageCode(), isTargetLanguageCode(), Language, languageLabel(), LANGUAGES, NATIVE_LANGUAGES (+13 more)
...
Cohesion: 0.12
Nodes (13): Consent Log, Script, W5 Consent Script, D+1, D+7, Logging, W5 Follow-Up Messages, After The Session (+5 more)
...
Cohesion: 0.11
Nodes (25): GardenCounts(), GardenPlot(), STAGE_SIZE, PlantSprite(), clamp01(), computeGardenSnapshot(), deriveGrowthEvidence(), GardenCounts (+17 more)
...
Cohesion: 0.18
Nodes (16): EMPTY_DATA, GardenHeader(), gardenExperimentVariant, GardenStage, GrowthEvidence, emitGardenValidation(), GardenValidationEvent, getGardenValidationLog() (+8 more)
...
Cohesion: 0.15
Nodes (23): Card(), CardProps, GardenGroupSection(), SeedRow(), STAGE_LABEL, BandGateNote(), CyclePicker(), MethodCoach() (+15 more)
...
Cohesion: 0.16
Nodes (16): groupRefinementsByDimension(), RegisterGap, refinement(), C1Diagnosis, NaturalnessReviewProps, ProgressData, ProgressInput, phraseSource (+8 more)
...
Cohesion: 0.07
Nodes (59): POST(), validEntry, metadata, AppMockup(), HeroSection(), HeroSectionProps, InsideSection(), LandingPage() (+51 more)
...
Cohesion: 0.09
Nodes (22): Arquitetura Resumida, Ciclo Adaptativo Shipped, Decisao Central De Identidade, Decisao Final, Diferenciais, Estado Atual, Guardrails De Launch, Metodo De Trabalho (+14 more)
...
Cohesion: 0.20
Nodes (14): POST(), POST(), safeLang(), provider(), PUT(), value(), JsonObject, isInternalSettingsRequest() (+6 more)

### Community 71 - "useUnlockedTabs.ts"
Cohesion: 0.21
Nodes (16): Button, formatTime(), SegmentRow(), SegmentRowProps, TranscriptReview(), TranscriptReviewProps, DiscoverResult, TranscriptSegment (+8 more)
...
Cohesion: 0.19
Nodes (16): buildDefaultPlanMeta(), DEFAULT_PLANS, DefaultPlanId, defaultPlanIdForLevel(), ensureDefaultPlan(), installDefaultPlan(), representativeMinutes(), targetLevelFor() (+8 more)
...
Cohesion: 0.21
Nodes (9): StatusPill(), StatusPillProps, toneClass, PROVIDER_COPY, SettingsScreen(), statusLabel(), StatusTone, subscribeToProfile() (+1 more)
...
Cohesion: 0.15
Nodes (16): SourcePicker(), SourcePickerProps, SOURCE_KINDS, DEMO_CARD_IDS, DEMO_PHRASES, demoDeckFor(), DemoPhrase, demoResult (+8 more)

### Community 92 - "Ollama Models Hook"
Cohesion: 0.14
Nodes (24): ConversationTurn, ConverseOptions, CorrectOptions, ProviderRegistry, ClaudeProviderOptions, ollamaBaseUrl(), OllamaProvider, OllamaProviderOptions (+16 more)
...
### Community 114 - "validation-action-plan.md"
Cohesion: 0.50
Nodes (3): How to add a recording, native-audio — real native-speaker recordings, The first-run gate (what W5 needs)
...
Cohesion: 0.23
Nodes (11): AppProviders(), SpeechTab(), Ctx, KOKORO_VOICE_OPTIONS, KokoroVoice, toKokoroVoice(), TtsSettings, TtsSettingsProvider() (+3 more)

### Community 117 - "AsciiLoop.tsx"
Cohesion: 0.14
Nodes (15): archivoBlack, fontVariables, metadata, fontVariables, metadata, ThemeInitScript(), getStoredTheme(), getSystemTheme() (+7 more)

### Community 118 - "demoFixture.ts"
Cohesion: 0.22
Nodes (8): Behavioral measures, Decision, Evidence rules under test, Experiment, Garden retention MVP — first validation, Instrumentation, Moderated comprehension check, Question
...
### Community 123 - "W5 Moderator Run-Sheet"
Cohesion: 0.43
Nodes (7): assessPronunciation(), PronunciationCoach(), PronunciationCoachProps, Score(), scoreTone(), wordClass(), savePronunciationAttempt()

### Community 124 - "route.integration.test.ts"
Cohesion: 0.29
...
### Community 129 - "PhraseLoop landing — W5 demand test"
Cohesion: 0.33
...
### Community 192 - "App Boundaries and Runtime Shape"
Cohesion: 0.28
Nodes (10): AppHeader(), AppHeaderProps, emptySubscribe(), useIsClient(), useTheme(), browserDownloadApkg(), saveApkg(), getAiSettingsBridge() (+2 more)

### Community 207 - "Landing Demand Test"
Cohesion: 0.40
Nodes (4): Audited Surfaces, Deferred External Copy, Language Rule, W5 User-Facing Language Audit

### Community 208 - "Native Clips W5 Blocker"
Cohesion: 0.50
...
### Community 230 - "AppProviders.tsx"
Cohesion: 0.14
Nodes (18): isLevelAtLeast(), GOAL_OPTIONS, OnboardingDialog(), Step, STEPS, subscribe(), isOnboardingComplete(), resolveInterfaceLang() (+10 more)
...
- **Why does `useT()` connect `Lesson View UI` to `App Boundaries and Runtime Shape`, `Study Plan Adaptation`, `First-Run Activation`, `AppProviders.tsx`, `useUnlockedTabs.ts`, `Landing Site UI`, `Card API Integration Tests`, `Discover & Provider Selection`, `UI Primitives & Motion Tokens`, `Audio Player & History`, `Study Card Scaffolding`, `Activation Event Model`, `W5 Moderator Run-Sheet`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `count()` connect `Local Store Repository` to `UI Primitives & Motion Tokens`, `W5 Decision-Gate Scorer`?**
