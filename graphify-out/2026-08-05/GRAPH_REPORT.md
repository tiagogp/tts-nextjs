# Graph Report - text-to-speech  (2026-08-05)

## Corpus Check
- 399 files · ~814,541 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2754 nodes · 7638 edges · 235 communities (126 shown, 109 thin omitted)
...
7. `EnglishLevel` - 39 edges
8. `Button` - 36 edges
9. `getLearningProfile()` - 36 edges
10. `Card()` - 35 edges
...
Cohesion: 0.09
Nodes (32): TabErrorBoundaryProps, TabErrorBoundaryState, TabErrorFallback(), Card(), CardProps, NaturalnessReview(), LocalPlacementCheck(), SELF_RATINGS (+24 more)

### Community 3 - "First-Run Activation"
Cohesion: 0.06
Nodes (98): C1Tab(), LessonViewContent(), resultForLesson(), waitForAudioEvent(), CRITERION_LABEL, ReadinessCoach(), retakeAvailableAt(), deriveProgressionState() (+90 more)

### Community 4 - "Learn Audio Generation Script"
Cohesion: 0.12
Nodes (35): sendConversationTurn(), synthesizeSpeech(), ConverseTab(), formatWhen(), TurnBubble(), CONVERSATION_LEVELS, CONVERSATION_SCENARIOS, ConversationLevel (+27 more)
...
Cohesion: 0.36
Nodes (8): Button, formatTime(), SegmentRow(), SegmentRowProps, TranscriptReview(), TranscriptReviewProps, DiscoverResult, TranscriptSegment
...
Cohesion: 0.07
Nodes (46): ButtonProps, buttonVariants, Chip, ChipProps, Disclosure(), DisclosureProps, Field(), FieldProps (+38 more)

### Community 14 - "Native Audio Decoding"
Cohesion: 0.20
Nodes (19): SessionResult, SessionSummary(), summarize(), line(), makeResult(), makeSrs(), t(), tomorrowLine() (+11 more)

### Community 15 - "Ingestion API Routes"
Cohesion: 0.17
Nodes (35): POST(), cardProviderKind(), POST(), parseTurns(), POST(), POST(), toEnglishLevel(), POST() (+27 more)

### Community 16 - "Local Server Routes"
Cohesion: 0.14
Nodes (30): GET(), GET(), GET(), LABELS, PATCH(), provider(), PUT(), value() (+22 more)
...
Cohesion: 0.10
Nodes (21): POST(), GET(), GET(), POST(), POST(), safeLang(), YOUTUBE_IMPORT_ERROR, POST() (+13 more)
...
Cohesion: 0.13
Nodes (10): Embedder, phraseSource, CardGenerationProvider, DeckResult, ClaudeProvider, OpenRouterProvider, AdvancedReview, Card (+2 more)

### Community 25 - "APKG Export Handling"
Cohesion: 0.14
Nodes (32): createApkgDebugId(), audioPathFor(), kokoroInstalled(), modelStatus, whisperInstalled(), ANY_ROUTES, dispatch(), handleAnkiApkg() (+24 more)
...
Cohesion: 0.16
Nodes (19): combinedSignal(), timeoutError(), POST(), clamp(), extractLinesFromJson(), normalizeLines(), POST(), PublicRouteError (+11 more)
...
Cohesion: 0.05
Nodes (42): archivoBlack, fontVariables, metadata, viewport, fontVariables, metadata, AppHeader(), AppHeaderProps (+34 more)
...
Cohesion: 0.17
Nodes (6): GOAL_OPTIONS, OnboardingDialog(), subscribe(), completeOnboarding(), isOnboardingComplete(), MemoryStorage
...
Cohesion: 0.21
Nodes (16): POST(), PROVIDER_FALLBACK_LABELS, ExportErrorPayload, linesFromText(), parseThemePhraseCount(), uniquePhrases(), POST(), safeLevel() (+8 more)
...
Cohesion: 0.19
Nodes (13): HomeContent(), Overlay, recommendedLessonId(), resolveLessonId(), SpeakTab(), useDockDueBadge(), computeUnlockedTabTier(), highestNewTab() (+5 more)
...
Cohesion: 0.31
Nodes (8): groupRefinementsByDimension(), RegisterGap, refinement(), C1Diagnosis, NaturalnessReviewProps, AdvancedReviewSummary, RefinementDimension, RefinementEvent
...
Cohesion: 0.20
Nodes (17): abortError(), debug(), deterministicCritique(), generateDeck(), generateVettedCards(), hasSourceSupport(), isAbortError(), isSourceGrounded() (+9 more)
...
Cohesion: 0.07
Nodes (49): EnglishLevel, generateLevelTest(), gradeLevelWriting(), LevelTestFlow(), LevelTestFlowProps, Stage, LocalPlacementCheckProps, blank() (+41 more)
...
Cohesion: 0.14
Nodes (15): PageHeader(), PageHeaderProps, ProviderBadge(), ProviderBadgeProps, StatusPill(), StatusPillProps, toneClass, hasCloudConsent() (+7 more)
...
Cohesion: 0.10
Nodes (24): buildLevelTestPrompt(), buildWritingGradePrompt(), CritiqueVerdict, AdvancedReviewResult, CEFR_LANGUAGE_PROFILE, cefrLanguageLine(), coerceErrorType(), CorrectedError (+16 more)
...
Cohesion: 0.18
Nodes (12): MethodArea, nextTaskId(), TodayPlanCard(), applyObjectiveDistribution(), AREA_TASKS, countTaskAreas(), nextArea(), task() (+4 more)
...
Cohesion: 0.23
Nodes (18): LessonView(), buildDeckFromPhrases(), completedLessonIdsFromCardIds(), firstLesson(), Lesson, lessonById(), lessonCardIds(), LessonComprehensionQuestion (+10 more)
...
Cohesion: 0.20
Nodes (13): ConversationTurn, ConverseOptions, GenerationRunOptions, ClaudeProviderOptions, OpenAIProvider, OpenAIProviderOptions, logUsage(), requestOptions() (+5 more)
...
Cohesion: 0.09
Nodes (34): Segmented(), SegmentedOption, SegmentedProps, Select(), SelectOption, SelectProps, ProviderPicker(), Selection (+26 more)
...
Cohesion: 0.11
Nodes (27): AdaptationKind, AdaptationSuggestion, evaluateAdaptation(), PlanOnboardingProps, buildDefaultPlanMeta(), DEFAULT_PLANS, DefaultPlanId, defaultPlanIdForLevel() (+19 more)
...
Cohesion: 0.09
Nodes (39): RetryStepProps, ProgressData, ProgressInput, NOW, review(), unaidedProductionPair(), BandQueueResult, fatigueByCard() (+31 more)
...
### Community 113 - "Done"
Cohesion: 0.33
Nodes (5): FAMILIAR_TOPICS, monologueSeconds(), selectFamiliarTopic(), supportForProgression(), production()
...
Cohesion: 0.19
Nodes (14): ThemeResponse, ollamaBaseUrl(), OllamaProviderOptions, CardSourceRef, ContentSource, DiscoveryRequest, PhraseCandidate, PhraseStatus (+6 more)
...
Cohesion: 0.13
Nodes (18): HojeHome(), isProductionAttemptEvent(), NextAction, resolveNextAction(), routeHandler(), WeeklyTransferCard(), WeeklyTransferSuggestion, DueCardLike (+10 more)
...
Cohesion: 0.50
Nodes (4): NOW, pair(), review(), CardDirection
...
Cohesion: 0.20
Nodes (12): CorrectOptions, OllamaProvider, OpenRouterProviderOptions, extractJson(), buildAdvancedReviewRequest(), buildCorrectRequest(), buildGenerateRequest(), normalizeAdvancedReview() (+4 more)

### Community 130 - "C1Tab.tsx"
Cohesion: 0.24
Nodes (9): FlaggedItem, GrammarGap, micFallbackAvailable(), assessPronunciation(), PronunciationCoach(), PronunciationCoachProps, Score(), scoreTone() (+1 more)
...
Cohesion: 0.11
Nodes (23): average(), deriveListeningStage(), deriveReadingWritingStage(), deriveSpeakingStage(), FamiliarTopic, FamiliarTopicHistoryItem, LISTENING_STAGE_CRITERIA, LISTENING_STAGES (+15 more)
...
Cohesion: 0.13
Nodes (32): computeUnaidedProduction(), isUnaided(), UnaidedProductionStats, activeDayCount(), avg(), buildMilestones(), clampScore(), computeProgressSnapshot() (+24 more)
...
## Knowledge Gaps
- **839 isolated node(s):** `eslintConfig`, `nextConfig`, `name`, `version`, `private` (+834 more)
...
- **Why does `ErrorEvent` connect `Learning Rubrics` to `Demo Fixture Data`, `openrouter.ts`, `First-Run Activation`, `Learn Audio Generation Script`, `Landing Site UI`, `AI Settings API`, `Ingestion API Routes`, `Discover & Provider Selection`, `SRS Analytics Dashboard`, `Card Export API`, `Correction Input Forms`, `Ollama Card Provider`, `IndexedDB Access Layer`, `Conversation Providers`, `Lesson View UI`, `effort.ts`, `W5 Validation Protocol`, `shared.ts`, `useStageTimer`, `classifyProviderFailure`, `inputOutput.integration.test.ts`, `AdvancedReview`?**
