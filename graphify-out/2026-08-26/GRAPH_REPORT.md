# Graph Report - text-to-speech  (2026-08-26)

## Corpus Check
- 424 files · ~852,896 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3025 nodes · 8444 edges · 252 communities (142 shown, 110 thin omitted)
- Extraction: 98% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 125 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c5936334`
...
2. `cn()` - 72 edges
3. `Card` - 59 edges
4. `ErrorEvent` - 48 edges
5. `ProviderKind` - 47 edges
6. `ConverseTab()` - 45 edges
7. `EnglishLevel` - 42 edges
8. `GenerationRunOptions` - 42 edges
9. `Button` - 40 edges
10. `readJsonObject()` - 37 edges
...
## Communities (252 total, 110 thin omitted)

### Community 0 - "Study Plan Adaptation"
Cohesion: 0.31
Nodes (9): CorrectTab(), MistakeStep(), notifyPerformanceEvidenceSaved(), saveAudioRecording(), saveCorrectionDeck(), saveErrorEvents(), saveListeningAttempt(), saveProductionAttempt() (+1 more)

### Community 1 - "Demo Fixture Data"
Cohesion: 0.13
Nodes (22): actionForStage(), activityMinutes(), add(), AREA_LABEL, balanceFor(), DEFAULT_TARGET, deriveMethodPlan(), lastStageAt() (+14 more)

### Community 2 - "Shared Feature UI Widgets"
Cohesion: 0.05
Nodes (68): SpeakTab(), TabErrorBoundaryProps, TabErrorBoundaryState, TabErrorFallback(), Button, ButtonProps, buttonVariants, Card() (+60 more)

### Community 3 - "First-Run Activation"
Cohesion: 0.17
Nodes (19): deletePlan(), getAllPlans(), del(), get(), getAll(), getMany(), makeCard(), seedLegacyDb() (+11 more)

### Community 4 - "Learn Audio Generation Script"
Cohesion: 0.10
Nodes (20): 1. Captura de conteúdo real, 2. Seleção de frases úteis, 3. Revisão espaçada, 4. Produção e correção, 5. Reforço das dificuldades, Como funciona, Comparação de posicionamento, Diferenciais complementares (+12 more)
...
Cohesion: 0.15
Nodes (17): computeDueReviewRhythm(), computeReturnAfterMiss(), computeWeeklyActivity(), dayIndex(), dayKey(), detectWeaknesses(), DueDayStatus, DueReviewRhythm (+9 more)

### Community 9 - "Landing Site UI"
Cohesion: 0.09
Nodes (36): RFC-5987, RFC-6266, ApkgErrorPayload, csvEscapeCell(), isProbablyJsonUpload(), isTimeoutOrAbort(), jsonToCsvBytes(), jsonToCsvBytesFromParsed() (+28 more)
...
Cohesion: 0.13
Nodes (24): isLanguageCode(), isNativeLanguageCode(), isTargetLanguageCode(), Language, languageLabel(), LANGUAGES, NATIVE_LANGUAGES, TARGET_LANGUAGES (+16 more)

### Community 14 - "Native Audio Decoding"
Cohesion: 0.12
Nodes (30): GRADE_TONE, GradeButtons(), card(), freshCard(), stableCard(), bandGateMetrics, BandVerdict, CardLike (+22 more)

### Community 15 - "Ingestion API Routes"
Cohesion: 0.13
Nodes (19): POST(), POST(), safeLang(), YOUTUBE_IMPORT_ERROR, formText(), POST(), POST(), clamp() (+11 more)

### Community 16 - "Local Server Routes"
Cohesion: 0.09
Nodes (45): GET(), GET(), LABELS, PATCH(), provider(), PUT(), value(), POST() (+37 more)
...
Cohesion: 0.13
Nodes (19): ActivationTiming, C1DiagnosisCompletedPayload, CardsCreatedPayload, CardsReviewedPayload, getActivityByType(), getActivityEvent(), getListeningAttempts(), getProductionAttempts() (+11 more)
...
Cohesion: 0.14
Nodes (23): Chip, Field(), FieldProps, Input, Textarea, DeckGenerationError, JsonImportForm(), JsonImportFormProps (+15 more)
...
Cohesion: 0.15
Nodes (41): POST(), POST(), POST(), PROVIDER_FALLBACK_LABELS, ExportErrorPayload, cardProviderKind(), combinedSignal(), linesFromText() (+33 more)
...
Cohesion: 0.11
Nodes (31): HomeContent(), Overlay, recommendedLessonId(), resolveLessonId(), useDockDueBadge(), useUnlockedTabs(), PageHeader(), PageHeaderProps (+23 more)

### Community 25 - "APKG Export Handling"
Cohesion: 0.16
Nodes (26): audioPathFor(), ANY_ROUTES, dispatch(), handleAnkiApkg(), handleCardsApkg(), handleDiscover(), handleDiscoverArticle(), handleDiscoverClip() (+18 more)
...
Cohesion: 0.16
Nodes (15): DueCardLike, endOfTodayLocal(), endOfTomorrowLocal(), localDayIndex(), mistakeCardStats(), ReturnMoment, returnMomentFor(), NOW (+7 more)

### Community 28 - "Card Prompt Builders"
Cohesion: 0.13
Nodes (27): DELETE(), GET(), dataDir(), discoverCacheDir(), linuxDataDirs(), modelDirs(), modelsDir(), active (+19 more)

### Community 29 - "SRS Cycle Planner"
Cohesion: 0.16
Nodes (17): hasCloudConsent(), PROVIDER_COPY, recordCloudConsent(), SettingsScreen(), statusLabel(), StatusTone, subscribeToProfile(), clearAll() (+9 more)
...
Cohesion: 0.16
Nodes (19): Notice(), NoticeProps, toneClass, basename(), DeckPreview(), DeckPreviewProps, ankiConnect(), browserDownload() (+11 more)

### Community 34 - "Study Session Modes"
Cohesion: 0.08
Nodes (36): buildLevelTestPrompt(), buildWritingGradePrompt(), TaskCompletionStatus, AdvancedReviewResult, buildAdvancedReviewRequest(), buildCorrectRequest(), buildCritiqueRequest(), buildGenerateRequest() (+28 more)
...
Cohesion: 0.08
Nodes (26): Arquitetura Resumida, Backlog original incorporado pelo validador, Ciclo Adaptativo Shipped, Curriculo De 100 Licoes, Decisao Central De Identidade, Decisao Final, Diferenciais, Estado Atual (+18 more)

### Community 38 - "Ollama Card Provider"
Cohesion: 0.16
Nodes (15): alignBlockDays(), chunkContext(), generateAndSavePlan(), GeneratedDay, GeneratePlanOptions, normalizePhases(), phaseResolver(), day() (+7 more)

### Community 39 - "Root TypeScript Config"
Cohesion: 0.15
Nodes (20): defaultTargetLevel(), levelIndex(), PlanOnboarding(), PlanOnboardingProps, AVAILABILITY_OPTIONS, PLAN_DAYS_OPTIONS, TARGET_LEVELS, cancelPlanGeneration() (+12 more)
...
Cohesion: 0.22
Nodes (14): computeAndSaveEffortSnapshot(), computeStreak(), MINUTES_PER_EVENT, plannedMinutesForWeek(), startOfWeek(), saveEffortSnapshot(), DayStatus, addDays() (+6 more)

### Community 42 - "Card Deck Preview UI"
Cohesion: 0.25
Nodes (10): POST(), safeLevel(), safeSourceKind(), toSegment(), isObject(), JsonObject, HttpError, httpUrl() (+2 more)
...
Cohesion: 0.14
Nodes (19): AppProviders(), isLevelAtLeast(), LEVEL_RANK, CORRECTIONS, MUST_NOT_FIRE, LearningProfile, TtsSettingsProvider(), resolveInterfaceLang() (+11 more)

### Community 45 - "Content Discovery Pipeline"
Cohesion: 0.11
Nodes (37): adaptProviderKind(), POST(), POST(), readCounts(), readRecentDays(), POST(), PLAN_METRIC_ACTIONS, PLAN_TASK_TYPES (+29 more)
...
Cohesion: 0.23
Nodes (5): GenerationRunOptions, OpenAIProvider, OpenRouterProvider, logUsage(), requestOptions()
...
Cohesion: 0.23
Nodes (15): abortError(), debug(), deterministicCritique(), generateDeck(), generateVettedCards(), isAbortError(), isSourceGrounded(), mapWithConcurrency() (+7 more)
...
Cohesion: 0.12
Nodes (26): TabGates, EnglishLevel, LocalPlacementCheck(), LocalPlacementCheckProps, SELF_RATINGS, Stage, blank(), buildPlacementCheck() (+18 more)

### Community 57 - "Fatigue-Aware Band Queue"
Cohesion: 0.10
Nodes (20): build, appId, dmg, extraResources, files, linux, nsis, productName (+12 more)
...
Cohesion: 0.15
Nodes (14): AdaptationKind, AdaptationSuggestion, evaluateAdaptation(), PlanGenerationRequest, generatorMock, loadJob(), meta, plan (+6 more)
...
Cohesion: 0.22
Nodes (23): activeDayCount(), attemptWordsPerMinute(), avg(), buildMilestones(), clampScore(), computeProgressSnapshot(), confidenceFor(), ConfidenceIndicators (+15 more)

### Community 68 - "linux"
Cohesion: 0.19
Nodes (17): Spinner(), AnkiExporter(), decodeRFC5987Value(), EN_ENGINE, ExportStatus, filenameFromContentDisposition(), isJsonFile(), safeDownloadFilename() (+9 more)
...
Cohesion: 0.17
Nodes (23): TurnBubble(), RepertoirePanel(), buildRepertoireCards(), carrierSentence(), dropRestatedGlossLines(), isPlausibleExpression(), markedExpressions(), markRepertoireUsed() (+15 more)
...
Cohesion: 0.10
Nodes (31): RetryStep(), CATEGORY_BY_ERROR, FEEDBACK_CATEGORY_LABEL, FEEDBACK_PRIORITY_LABEL, FeedbackCategory, feedbackIssue, FeedbackIssueBase, feedbackKey() (+23 more)
...
Cohesion: 0.06
Nodes (65): POST(), validEntry, metadata, structuredData, AppMockup(), HeroSection(), HeroSectionProps, InsideSection() (+57 more)
...
Cohesion: 0.28
Nodes (7): PlanTaskRow(), CALENDAR_STATUS_DOT, CALENDAR_STATUS_RING, MONTH_NAMES, TASK_COLORS, TASK_LABELS, WEEKDAY_LABELS
...
Cohesion: 0.14
Nodes (24): HeldPhrasesCard(), containsPortugueseAccent(), ENGLISH_MARKERS, isLikelyEnglish(), isLikelyPortuguese(), isLikelyPortugueseText(), meaningTextOfCard(), normalized() (+16 more)
...
Cohesion: 0.15
Nodes (23): SessionResult, SessionSummary(), summarize(), line(), makeResult(), makeSrs(), t(), tomorrowLine() (+15 more)
...
Cohesion: 0.18
Nodes (19): ComprehensionQuestion, evaluateAttempt(), FillInQuestion, gradeObjectiveSections(), LevelTest, LevelTestContent, nonEmptyStr(), normalizeAnswer() (+11 more)
...
Cohesion: 0.10
Nodes (27): Select(), SelectOption, SelectProps, WorkflowSteps(), WorkflowStepsProps, ProviderPicker(), Selection, DeckGeneration (+19 more)
...
### Community 109 - "Learning Rubrics"
Cohesion: 0.11
Nodes (28): BandQueueResult, familyOf(), fatigueByCard(), interleaveDueQueue(), orderDueQueue(), adoptLog(), due(), NOW (+20 more)
...
### Community 113 - "Done"
Cohesion: 0.25
Nodes (12): ConversationTurn, ConverseOptions, CorrectionResult, OllamaProviderOptions, OpenAIProviderOptions, OpenRouterProviderOptions, extractJson(), UsageLike (+4 more)
...
Cohesion: 0.15
Nodes (10): Embedder, CardGenerationProvider, CorrectOptions, DeckResult, ClaudeProvider, OllamaProvider, AdvancedReview, Card (+2 more)

### Community 116 - "TabErrorBoundary"
Cohesion: 0.16
Nodes (16): generateLevelTest(), gradeLevelWriting(), LevelTestFlow(), LevelTestFlowProps, Stage, AttemptEvaluation, LevelTestAnswers, WritingGradeSummary (+8 more)

### Community 117 - "audioMetadata.ts"
Cohesion: 0.26
Nodes (11): groupRefinementsByDimension(), RegisterGap, refinement(), NaturalnessReview(), NaturalnessReviewProps, AdvancedReviewSummary, CardSourceRef, CritiqueVerdict (+3 more)

### Community 118 - "PULL_REQUEST_TEMPLATE.md"
Cohesion: 0.50
Nodes (3): Risk Checklist, Summary, Validation
...
Cohesion: 0.14
Nodes (22): count(), countFromIndex(), getAllFromIndex(), base64ToBytes(), bytesToBase64(), cardMatchesWeakness(), countDueCards(), getConversation() (+14 more)
...
Cohesion: 0.25
Nodes (7): CycleInputs, CycleOption, CyclePath, CyclePlan, deriveCyclePlan(), minutesLabel(), weighted()

### Community 125 - "PhraseLoop landing — demand test"
Cohesion: 0.12
Nodes (13): Response to the learning-method audit, Analysis, Claim under test, Decision rules, Design, Execution checklist, Learning-efficacy experiment, Measurement contract (+5 more)
...
Cohesion: 0.13
Nodes (31): LessonView(), ALL_LESSON_CONTENT, buildDeckFromPhrases(), firstLesson(), hasCompleteGuidedMaterial(), LEGACY_PHRASE_BANK, Lesson, lessonById() (+23 more)
...
### Community 129 - "generationJob.ts"
Cohesion: 0.26
...
### Community 132 - "db.ts"
Cohesion: 0.16
Nodes (19): HojeHomeProps, countTaskEvidence(), EvidencePayload, payload(), PlanEvidenceTask, taskEvidenceMeetsTarget(), TodayPlanState, useTodayPlan() (+11 more)

### Community 134 - "C1Tab.tsx"
Cohesion: 0.13
Nodes (28): sendConversationTurn(), synthesizeSpeech(), ConverseTab(), ConverseTabProps, formatWhen(), RepertoireRecall(), ADVANCED_CONVERSATION_SCENARIOS, CONVERSATION_LEVELS (+20 more)

### Community 184 - "Learning-efficacy experiment"
Cohesion: 0.18
Nodes (13): AppHeader(), AppHeaderProps, emptySubscribe(), useIsClient(), HOME_TABS, HomeTab, useTheme(), computeUnlockedTabTier() (+5 more)
...
Cohesion: 0.06
Nodes (56): LessonViewContent(), resultForLesson(), waitForAudioEvent(), CRITERION_LABEL, ReadinessCoach(), ADVANCED_CONVERSATION_FLOOR, average(), decisionReason() (+48 more)

### Community 238 - "MistakeStep.tsx"
Cohesion: 0.27
Nodes (10): micFallbackAvailable(), production(), assessPronunciation(), PronunciationCoach(), PronunciationCoachProps, Score(), scoreTone(), wordClass() (+2 more)

### Community 239 - "RecordingComparison.tsx"
Cohesion: 0.19
Nodes (16): RetryStepProps, LevelReadinessInput, ProgressData, ProgressInput, ProgressSnapshot, StoredProgressAssessment, NOW, review() (+8 more)

### Community 240 - "PhraseLoop landing — demand test"
Cohesion: 0.23
...
### Community 241 - "OllamaProvider"
Cohesion: 0.33
Nodes (6): mac, category, icon, identity, minimumSystemVersion, target

### Community 242 - "inputOutput.integration.test.ts"
Cohesion: 0.15
Nodes (20): BandThresholds, clamp01(), computeLevelReadiness(), gapEvidence(), isBlocking(), LADDER, LevelReadiness, nextLevelOf() (+12 more)

### Community 245 - "C1Tab.tsx"
Cohesion: 0.16
Nodes (13): ProviderBadge(), ProviderBadgeProps, StatusPill(), StatusPillProps, toneClass, C1Tab(), FlaggedItem, GrammarGap (+5 more)

### Community 246 - "useStudySession"
Cohesion: 0.20
Nodes (16): loadOrderedDueQueue(), loadStudySnapshot(), useStudySession(), orientCardsForTargetFront(), getActivityLog(), ensureProductiveCardPairs(), getCard(), getCardsWithSrs() (+8 more)

### Community 247 - "metrics.ts"
Cohesion: 0.24
...
### Community 248 - "types.ts"
Cohesion: 0.26
Nodes (7): Segmented(), SegmentedOption, SegmentedProps, SourcePicker(), SourcePickerProps, SOURCE_KINDS, DiscoverSourceKind

### Community 249 - "transferErrors.ts"
Cohesion: 0.18
Nodes (9): BE_FOR_SUBJECT, COMPARATIVE, PARTICIPLE, PROFESSIONS_WITH_AN, TRANSFER_RULES, TransferCheckResult, TransferRule, TransferRuleHit (+1 more)

### Community 250 - "PhraseLoop — Architecture & Build Record"
Cohesion: 0.29
...
### Community 252 - "Critica De Produto"
Cohesion: 0.50
...
## Knowledge Gaps
- **922 isolated node(s):** `eslintConfig`, `nextConfig`, `name`, `version`, `private` (+917 more)
...
- **Why does `line()` connect `StudyCard.tsx` to `Provider Selection Constants`, `Electron Main Process`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Anki Deck Builder` to `Native RPath Fix Script`, `Mac Build Script`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `useT()` connect `Shared Feature UI Widgets` to `Study Plan Adaptation`, `C1Tab.tsx`, `Native Audio Decoding`, `W5 Decision-Gate Scorer`, `Card Export API`, `Correction Input Forms`, `SRS Cycle Planner`, `Progress Scoring Model`, `Root TypeScript Config`, `IndexedDB Access Layer`, `Learning-efficacy experiment`, `effort.ts`, `RecordingComparison.tsx`, `ExposureMeter.tsx`, `linux`, `shared.ts`, `SpeechTab.tsx`, `useDockDueBadge.ts`, `useStageTimer`, `cyclePlanner.ts`, `StudyCard.tsx`, `LessonView.tsx`, `MistakeStep.tsx`, `TabErrorBoundary`, `C1Tab.tsx`, `audioMetadata.ts`, `useStudySession`, `types.ts`, `lessonFlow.ts`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **What connects `eslintConfig`, `nextConfig`, `name` to the rest of the system?**
  _936 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Demo Fixture Data` be split into smaller, more focused modules?**
