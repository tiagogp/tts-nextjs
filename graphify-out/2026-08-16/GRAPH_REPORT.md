# Graph Report - text-to-speech  (2026-08-15)

## Corpus Check
- 416 files · ~834,907 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2913 nodes · 8111 edges · 240 communities (131 shown, 109 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 122 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `35f9789b`
...
5. `ProviderKind` - 45 edges
6. `EnglishLevel` - 42 edges
7. `GenerationRunOptions` - 42 edges
8. `Button` - 39 edges
9. `ConverseTab()` - 39 edges
...
## Communities (240 total, 109 thin omitted)

### Community 0 - "Study Plan Adaptation"
Cohesion: 0.06
Nodes (62): POST(), validEntry, metadata, structuredData, AppMockup(), HeroSection(), HeroSectionProps, InsideSection() (+54 more)
...
Cohesion: 0.09
Nodes (34): TabErrorBoundaryProps, TabErrorBoundaryState, TabErrorFallback(), ButtonProps, buttonVariants, Card(), CardProps, RetryStep() (+26 more)

### Community 3 - "First-Run Activation"
Cohesion: 0.08
Nodes (60): CRITERION_LABEL, ReadinessCoach(), retakeAvailableAt(), deletePlan(), ProgressOverview(), fatigueByCard(), loadOrderedDueQueue(), loadStudySnapshot() (+52 more)

### Community 4 - "Learn Audio Generation Script"
Cohesion: 0.21
Nodes (14): StatusPillProps, hasCloudConsent(), PROVIDER_COPY, recordCloudConsent(), SettingsScreen(), statusLabel(), StatusTone, subscribeToProfile() (+6 more)

### Community 6 - "App Layout & AI Settings"
Cohesion: 0.06
Nodes (36): 10. Exercise catalog, 11. AI feedback system, 12. Non-LLM learning strategy, 13. Motivation and progress system, 14. UX and navigation improvements, 15. Technical and architectural recommendations, 16. Session design, 17. Open-source strategy (+28 more)
...
Cohesion: 0.11
Nodes (24): endOfTomorrowLocal(), ProgressInput, ScaffoldTelemetry, buildLightQueue(), hasAudio(), isSaturated(), SessionMode, StudySnapshot (+16 more)

### Community 9 - "Landing Site UI"
Cohesion: 0.09
Nodes (37): RFC-5987, RFC-6266, ApkgErrorPayload, csvEscapeCell(), isProbablyJsonUpload(), isTimeoutOrAbort(), jsonToCsvBytes(), jsonToCsvBytesFromParsed() (+29 more)
...
Cohesion: 0.16
Nodes (22): isLanguageCode(), isNativeLanguageCode(), isTargetLanguageCode(), Language, languageLabel(), LANGUAGES, NATIVE_LANGUAGES, TARGET_LANGUAGES (+14 more)

### Community 14 - "Native Audio Decoding"
Cohesion: 0.12
Nodes (36): GRADE_TONE, GradeButtons(), SessionResult, SessionSummary(), summarize(), line(), makeResult(), makeSrs() (+28 more)

### Community 15 - "Ingestion API Routes"
Cohesion: 0.18
Nodes (26): POST(), POST(), POST(), ExportErrorPayload, cardProviderKind(), combinedSignal(), linesFromText(), parseThemePhraseCount() (+18 more)

### Community 16 - "Local Server Routes"
Cohesion: 0.13
Nodes (31): PROVIDER_FALLBACK_LABELS, GET(), GET(), GET(), LABELS, PATCH(), provider(), PUT() (+23 more)

### Community 17 - "Card API Integration Tests"
Cohesion: 0.06
Nodes (44): ActivationTiming, FirstRunActivation, FirstRunActivationSource, getStorage(), markFirstRunPhrasesSaved(), markFirstRunReviewCompleted(), read(), startFirstRunActivation() (+36 more)

### Community 18 - "Discover & Provider Selection"
Cohesion: 0.16
Nodes (9): NOW, pair(), review(), NOW, review(), unaidedProductionPair(), CardDirection, CardSourceRef (+1 more)
...
Cohesion: 0.16
Nodes (15): GET(), GET(), POST(), POST(), POST(), formText(), POST(), GET() (+7 more)

### Community 21 - "Plan Generation API"
Cohesion: 0.08
Nodes (39): ManualEntryFormProps, CORRECTION_ERROR_TYPES, CORRECTION_INPUT_OPTIONS, CorrectionDraft, CorrectionInputMode, ERROR_TYPE_SET, newDraft(), parseErrorsJson() (+31 more)

### Community 22 - "SRS Analytics Dashboard"
Cohesion: 0.06
Nodes (41): groupRefinementsByDimension(), RegisterGap, refinement(), C1Diagnosis, NaturalnessReviewProps, RetryStepProps, CATEGORY_BY_ERROR, FeedbackCategory (+33 more)

### Community 23 - "Package Dependencies"
Cohesion: 0.13
Nodes (18): AudioPlayer(), AudioPlayerProps, ENGINE_LABELS, HistoryItem(), HistoryItemProps, HistoryPanelProps, VOICE_LABELS, Ctx (+10 more)
...
Cohesion: 0.15
Nodes (29): createApkgDebugId(), audioPathFor(), ensureKokoroModel(), ANY_ROUTES, dispatch(), handleAnkiApkg(), handleCardsApkg(), handleDiscover() (+21 more)
...
Cohesion: 0.12
Nodes (21): ProviderBadge(), ProviderBadgeProps, Select(), SelectOption, SelectProps, StatusPill(), toneClass, C1Tab() (+13 more)
...
Cohesion: 0.10
Nodes (22): buildLevelTestPrompt(), buildWritingGradePrompt(), CritiqueVerdict, AdvancedReviewResult, CEFR_LANGUAGE_PROFILE, cefrLanguageLine(), CorrectedError, CorrectResult (+14 more)
...
Cohesion: 0.10
Nodes (28): PlanGenerationRequest, generatorMock, loadJob(), meta, plan, request, alignBlockDays(), chunkContext() (+20 more)

### Community 39 - "Root TypeScript Config"
Cohesion: 0.11
Nodes (21): HojeHomeProps, MethodRoute, PlanTaskRow(), nextTaskId(), ROUTE_TASK_TYPES, TodayPlanCard(), AVAILABILITY_OPTIONS, CALENDAR_STATUS_DOT (+13 more)
...
Cohesion: 0.13
Nodes (28): computeAndSaveEffortSnapshot(), computeStreak(), MINUTES_PER_EVENT, plannedMinutesForWeek(), startOfWeek(), countTaskEvidence(), EvidencePayload, payload() (+20 more)
...
Cohesion: 0.15
Nodes (15): AppProviders(), isLevelAtLeast(), LEVEL_RANK, TtsSettingsProvider(), resolveInterfaceLang(), UiLang, I18nProvider(), I18nValue (+7 more)

### Community 45 - "Content Discovery Pipeline"
Cohesion: 0.17
Nodes (16): HomeContent(), Overlay, recommendedLessonId(), resolveLessonId(), SpeakTab(), computeUnlockedTabTier(), highestNewTab(), tabsForUnlockTier() (+8 more)
...
Cohesion: 0.22
Nodes (16): buildDeckFromPhrases(), completedLessonIdsFromCardIds(), firstLesson(), Lesson, lessonCardIds(), LessonComprehensionQuestion, LessonDialogueLine, LessonMaterial (+8 more)
...
Cohesion: 0.24
Nodes (15): ProviderSelection, AiSettingsProvider(), AiSettingsValue, bridge(), Context, EMPTY_SETTINGS, ProviderKind, AiConnectionState (+7 more)
...
Cohesion: 0.17
Nodes (18): BandQueueResult, orderDueQueue(), DueCard, OrderedDueQueue, BandGateResult, BandVerdict, CardLike, clamp01() (+10 more)

### Community 63 - "Claude Card Provider"
Cohesion: 0.20
Nodes (10): DeckGenerationResult, DeckResult, OpenRouterProvider, Card, CardSource, buildCritiqueRequest(), buildGenerateRequest(), coerceErrorType() (+2 more)

### Community 64 - "C1 Phase Proposal"
Cohesion: 0.18
Nodes (26): computeUnaidedProduction(), isUnaided(), UnaidedProductionStats, activeDayCount(), avg(), buildMilestones(), clampScore(), computeProgressSnapshot() (+18 more)

### Community 65 - "W5 Validation Protocol"
Cohesion: 0.22
Nodes (10): CorrectOptions, ClaudeProvider, ClaudeProviderOptions, AdvancedReview, buildAdvancedReviewRequest(), buildCorrectRequest(), normalizeAdvancedReview(), normalizeCorrected() (+2 more)

### Community 68 - "linux"
Cohesion: 0.10
Nodes (40): Button, Chip, ChipProps, Field(), FieldProps, Input, Label(), Textarea (+32 more)
...
Cohesion: 0.15
Nodes (15): ConversationTab(), ConverseTabProps, formatWhen(), RepertoirePanel(), ADVANCED_CONVERSATION_SCENARIOS, CONVERSATION_LEVELS, CONVERSATION_SCENARIOS, ConversationLevel (+7 more)
...
Cohesion: 0.29
Nodes (13): TurnBubble(), buildRepertoireCards(), dropRestatedGlossLines(), isPlausibleExpression(), markedExpressions(), mergeRepertoire(), normalize(), ParsedRepertoire (+5 more)
...
Cohesion: 0.18
Nodes (15): AppHeader(), AppHeaderProps, emptySubscribe(), useIsClient(), HOME_TABS, HomeTab, useTheme(), useDockDueBadge() (+7 more)
...
Cohesion: 0.24
Nodes (12): targetForProfile(), applyObjectiveDistribution(), AREA_TASKS, countTaskAreas(), fallbackDays(), nextArea(), task(), TASK_AREA (+4 more)
...
Cohesion: 0.16
Nodes (10): PageHeader(), PageHeaderProps, WorkflowSteps(), WorkflowStepsProps, DeckGenerationError, generateCorrectionDeck(), AiEvaluateForm(), JsonImportForm() (+2 more)
...
Cohesion: 0.24
Nodes (15): containsPortugueseAccent(), ENGLISH_MARKERS, isLikelyEnglish(), isLikelyPortuguese(), normalized(), orientCardsForTargetFront(), PORTUGUESE_MARKERS, sameOrContainedInTarget() (+7 more)
...
Cohesion: 0.22
Nodes (9): DueCardLike, localDayIndex(), mistakeCardStats(), ReturnMoment, returnMomentFor(), NOW, TWO_DAYS_AGO, WEEK_AGO (+1 more)
...
Cohesion: 0.11
Nodes (42): POST(), toEnglishLevel(), POST(), toEnglishLevel(), adaptProviderKind(), POST(), POST(), readCounts() (+34 more)
...
Cohesion: 0.12
Nodes (24): Segmented(), SegmentedOption, SegmentedProps, DeckGeneration, DeckGenerationOptions, GenerationStage, useDeckGeneration(), authoredError() (+16 more)
...
### Community 101 - "route.integration.test.ts"
Cohesion: 0.16
Nodes (17): ThemeResponse, OllamaProvider, OllamaProviderOptions, OpenRouterProviderOptions, extractJson(), UsageLike, ContentSource, DiscoveryRequest (+9 more)
...
Cohesion: 0.09
Nodes (27): adoptLog(), due(), NOW, NOW_MS, review(), srs(), CycleInputs, CycleOption (+19 more)
...
Cohesion: 0.14
Nodes (14): 1. What this is, 2. The card pipeline — architecture, 7. Method implementation status, 8. Design and UX rules, 9. Technical backlog, Discovery flow: extract → curate → review, Linguagem visual, PhraseLoop — Architecture & Build Record (+6 more)

### Community 117 - "audioMetadata.ts"
Cohesion: 0.21
Nodes (10): Disclosure(), DisclosureProps, Modal(), ModalProps, PlanGenerationToast(), dismissPlanGeneration(), easeOut, fadeRise (+2 more)
...
Cohesion: 0.21
Nodes (10): isProductionAttemptEvent(), NextAction, resolveNextAction(), routeHandler(), WeeklyTransferCard(), WeeklyTransferSuggestion, buildTransferActivities(), TransferActivity (+2 more)

### Community 123 - "MemoryStorage"
Cohesion: 0.15
Nodes (8): GOAL_OPTIONS, OnboardingDialog(), Step, STEPS, subscribe(), completeOnboarding(), isOnboardingComplete(), MemoryStorage

### Community 124 - "PhraseLoop Validation Log"
Cohesion: 0.40
Nodes (4): Decision Rules, Interview Prompts, PhraseLoop Validation Log, Required Tasks
...
Cohesion: 0.25
Nodes (12): LessonComprehensionKind, buildListeningChallenge(), distinct(), learningPhrases(), ListeningAudio, ListeningChallengeOptions, ListeningChallengeResult, ListeningQuestion (+4 more)
...
### Community 132 - "db.ts"
Cohesion: 0.61
Nodes (7): count(), countFromIndex(), get(), getMany(), openDb(), reqToPromise(), getConversation()

### Community 134 - "route.integration.test.ts"
Cohesion: 0.29
Nodes (3): generateDeck, localJson, localRequest

### Community 184 - "adaptation.ts"
Cohesion: 0.40
...
Cohesion: 0.08
Nodes (32): ADVANCED_CONVERSATION_FLOOR, average(), deriveListeningStage(), deriveProgressionState(), deriveReadingWritingStage(), deriveSpeakingStage(), FAMILIAR_TOPICS, FamiliarTopic (+24 more)

### Community 238 - "MistakeStep.tsx"
Cohesion: 0.11
Nodes (49): sendConversationTurn(), synthesizeSpeech(), ConverseTab(), evaluateCorrectionText(), transcribeAudio(), CorrectTab(), countPolishFeedback(), useCorrectionAudio() (+41 more)

### Community 242 - "inputOutput.integration.test.ts"
Cohesion: 0.11
Nodes (27): ReadinessCoachProps, BandThresholds, clamp01(), computeLevelReadiness(), gapEvidence(), isBlocking(), LADDER, LevelReadiness (+19 more)
...
## Knowledge Gaps
- **891 isolated node(s):** `eslintConfig`, `nextConfig`, `name`, `version`, `private` (+886 more)
...
- **Why does `line()` connect `Native Audio Decoding` to `Provider Selection Constants`, `Electron Main Process`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `useT()` connect `Shared Feature UI Widgets` to `First-Run Activation`, `Learn Audio Generation Script`, `Local Store Repository`, `Native Audio Decoding`, `SRS Analytics Dashboard`, `Correction Input Forms`, `SRS Cycle Planner`, `Progress Scoring Model`, `Root TypeScript Config`, `IndexedDB Access Layer`, `Content Discovery Pipeline`, `Conversation Providers`, `effort.ts`, `linux`, `shared.ts`, `EnglishLevel`, `useStageTimer`, `LessonView.tsx`, `MistakeStep.tsx`, `AdvancedReview`, `audioMetadata.ts`, `ReviewRecord`?**
