# Graph Report - text-to-speech  (2026-08-16)

## Corpus Check
- 417 files · ~838,515 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2926 nodes · 8180 edges · 244 communities (134 shown, 110 thin omitted)
- Extraction: 98% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 122 edges (avg confidence: 0.71)
...
5. `ProviderKind` - 46 edges
6. `ConverseTab()` - 44 edges
...
## Communities (244 total, 110 thin omitted)
...
Cohesion: 0.10
Nodes (29): Card(), CardProps, PageHeader(), PageHeaderProps, ConversationTab(), JsonImportForm(), JsonImportFormProps, NaturalnessReview() (+21 more)

### Community 3 - "First-Run Activation"
Cohesion: 0.09
Nodes (48): useDockDueBadge(), clearAll(), count(), countFromIndex(), del(), get(), getMany(), makeCard() (+40 more)

### Community 4 - "Learn Audio Generation Script"
Cohesion: 0.12
Nodes (26): LessonComprehensionKind, ListeningQuestion, MethodProgressionState, EMPTY_DATA, formatDate(), ProgressCheckInCard(), ProgressData, ProgressSnapshotCard() (+18 more)
...
Cohesion: 0.10
Nodes (35): GOAL_OPTIONS, OnboardingDialog(), Step, STEPS, subscribe(), hasCloudConsent(), recordCloudConsent(), SettingsScreen() (+27 more)

### Community 14 - "Native Audio Decoding"
Cohesion: 0.20
Nodes (18): SessionResult, SessionSummary(), summarize(), line(), makeResult(), makeSrs(), t(), tomorrowLine() (+10 more)

### Community 15 - "Ingestion API Routes"
Cohesion: 0.18
Nodes (22): POST(), POST(), ExportErrorPayload, combinedSignal(), linesFromText(), parseThemePhraseCount(), readExportError(), timeoutError() (+14 more)

### Community 16 - "Local Server Routes"
Cohesion: 0.16
Nodes (23): PROVIDER_FALLBACK_LABELS, GET(), GET(), GET(), LABELS, PATCH(), POST(), providerRegistry (+15 more)
...
Cohesion: 0.14
Nodes (17): GET(), GET(), POST(), POST(), safeLang(), YOUTUBE_IMPORT_ERROR, POST(), POST() (+9 more)

### Community 21 - "Plan Generation API"
Cohesion: 0.07
Nodes (42): ManualEntryForm(), ManualEntryFormProps, CORRECTION_ERROR_TYPES, CORRECTION_INPUT_OPTIONS, CorrectionDraft, CorrectionInputMode, ERROR_TYPE_SET, newDraft() (+34 more)

### Community 22 - "SRS Analytics Dashboard"
Cohesion: 0.15
Nodes (21): RetryStep(), CATEGORY_BY_ERROR, FeedbackCategory, feedbackIssue, FeedbackIssueBase, feedbackKey(), FeedbackPriority, FeedbackPriorityOptions (+13 more)
...
Cohesion: 0.25
Nodes (11): ConversationTurn, ConverseOptions, GenerationRunOptions, ClaudeProviderOptions, OpenRouterProviderOptions, extractJson(), logUsage(), requestOptions() (+3 more)

### Community 25 - "APKG Export Handling"
Cohesion: 0.13
Nodes (35): createApkgDebugId(), audioPathFor(), ensureKokoroModel(), ensureOnce(), ensureWhisperModel(), kokoroInstalled(), modelStatus, whisperInstalled() (+27 more)
...
Cohesion: 0.13
Nodes (25): TabGates, EnglishLevel, LocalPlacementCheck(), LocalPlacementCheckProps, SELF_RATINGS, Stage, blank(), buildPlacementCheck() (+17 more)
...
Cohesion: 0.08
Nodes (37): Button, Field(), FieldProps, Input, Label(), Textarea, Modal(), ProviderBadge() (+29 more)
...
Cohesion: 0.09
Nodes (31): buildLevelTestPrompt(), buildWritingGradePrompt(), OpenAIProviderOptions, AdvancedReviewResult, buildAdvancedReviewRequest(), buildGenerateRequest(), buildMineRequest(), CEFR_LANGUAGE_PROFILE (+23 more)
...
Cohesion: 0.08
Nodes (34): cancelPlanGeneration(), getPlanJobState(), IDLE, listeners, PlanGenerationRequest, PlanJobState, retryPlanGeneration(), run() (+26 more)

### Community 39 - "Root TypeScript Config"
Cohesion: 0.15
Nodes (15): HojeHomeProps, AVAILABILITY_OPTIONS, CALENDAR_STATUS_DOT, CALENDAR_STATUS_RING, MONTH_NAMES, PLAN_DAYS_OPTIONS, TASK_COLORS, TASK_LABELS (+7 more)
...
Cohesion: 0.14
Nodes (23): AdaptationKind, AdaptationSuggestion, evaluateAdaptation(), computeAndSaveEffortSnapshot(), computeStreak(), MINUTES_PER_EVENT, plannedMinutesForWeek(), startOfWeek() (+15 more)

### Community 42 - "Card Deck Preview UI"
Cohesion: 0.23
Nodes (14): POST(), safeLevel(), safeSourceKind(), toSegment(), POST(), provider(), PUT(), value() (+6 more)
...
Cohesion: 0.18
Nodes (12): AppProviders(), TtsSettingsProvider(), UiLang, I18nProvider(), I18nValue, subscribe(), useInterfaceLang(), messages (+4 more)

### Community 45 - "Content Discovery Pipeline"
Cohesion: 0.18
Nodes (20): POST(), readCounts(), readRecentDays(), PLAN_METRIC_ACTIONS, PLAN_TASK_TYPES, GeneratedDay, GeneratedTask, validateGeneratedDays() (+12 more)
...
Cohesion: 0.11
Nodes (24): HomeContent(), Overlay, recommendedLessonId(), resolveLessonId(), SpeakTab(), TabErrorBoundary, LessonView(), buildDeckFromPhrases() (+16 more)
...
Cohesion: 0.10
Nodes (36): AiEvaluateForm(), AiEvaluateFormProps, LocalModelNotice(), NoticeCopy, useNoticeCopy(), LocalModelState, useLocalModel(), applyStatus() (+28 more)
...
Cohesion: 0.17
Nodes (20): browserDownloadApkg(), saveApkg(), ProviderSelection, AiSettingsProvider(), AiSettingsValue, bridge(), Context, EMPTY_SETTINGS (+12 more)
...
Cohesion: 0.11
Nodes (33): ProgressInput, BandQueueResult, fatigueByCard(), orderDueQueue(), adoptLog(), due(), NOW, NOW_MS (+25 more)

### Community 63 - "Claude Card Provider"
Cohesion: 0.22
Nodes (8): DeckGenerationResult, phraseSource, OllamaProvider, Card, CardSource, Critique, buildCritiqueRequest(), normalizeCritique()
...
Cohesion: 0.29
Nodes (8): RetryStepProps, CorrectOptions, ollamaApiRoot(), ollamaBaseUrl(), OllamaProviderOptions, ErrorEvent, buildCorrectRequest(), normalizeCorrected()

### Community 68 - "linux"
Cohesion: 0.08
Nodes (37): TabErrorBoundaryProps, TabErrorBoundaryState, TabErrorFallback(), ButtonProps, buttonVariants, Chip, ChipProps, Disclosure() (+29 more)
...
Cohesion: 0.10
Nodes (41): sendConversationTurn(), synthesizeSpeech(), ConverseTab(), ConverseTabProps, formatWhen(), TurnBubble(), RepertoirePanel(), RepertoireRecall() (+33 more)
...
Cohesion: 0.21
Nodes (17): GRADE_TONE, GradeButtons(), card(), freshCard(), stableCard(), bandGateMetrics, applyGrade(), deserialize() (+9 more)
...
Cohesion: 0.25
Nodes (11): targetForProfile(), applyObjectiveDistribution(), AREA_TASKS, countTaskAreas(), fallbackDays(), nextArea(), task(), TASK_AREA (+3 more)
...
Cohesion: 0.16
Nodes (36): POST(), cardProviderKind(), POST(), parseExpressions(), parseTurns(), POST(), POST(), toEnglishLevel() (+28 more)
...
Cohesion: 0.14
Nodes (22): DeckGeneration, DeckGenerationOptions, GenerationStage, useDeckGeneration(), authoredError(), curateDiscoverSegments(), extractDiscoverSource(), generateDiscoverDeck() (+14 more)
...
Cohesion: 0.18
Nodes (15): isLevelAtLeast(), LEVEL_RANK, buildDefaultPlanMeta(), DEFAULT_PLANS, DefaultPlanId, defaultPlanIdForLevel(), ensureDefaultPlan(), installDefaultPlan() (+7 more)

### Community 101 - "route.integration.test.ts"
Cohesion: 0.17
Nodes (9): ThemeResponse, OpenRouterProvider, ContentSource, DiscoveryRequest, PhraseCandidate, TranscriptSegment, request, source (+1 more)
...
Cohesion: 0.38
Nodes (6): ExposureMeter(), ZONE, exposureZone, getWeeklyGoal(), setWeeklyGoal(), subscribeWeeklyGoal()
...
Cohesion: 0.13
Nodes (37): HojeHome(), isProductionAttemptEvent(), NextAction, resolveNextAction(), routeHandler(), WeeklyTransferCard(), WeeklyTransferSuggestion, CRITERION_LABEL (+29 more)
...
Cohesion: 0.21
Nodes (17): LessonViewContent(), resultForLesson(), waitForAudioEvent(), buildListeningChallenge(), distinct(), learningPhrases(), ListeningAudio, ListeningChallengeOptions (+9 more)
...
### Community 132 - "db.ts"
Cohesion: 0.29
Nodes (10): countTaskEvidence(), EvidencePayload, payload(), PlanEvidenceTask, taskEvidenceMeetsTarget(), useTodayPlan(), getTodayTasks(), updateDayTask() (+2 more)

### Community 134 - "route.integration.test.ts"
Cohesion: 0.21
Nodes (4): Embedder, CardGenerationProvider, OpenAIProvider, AdvancedReview
...
### Community 185 - "TabErrorBoundary"
Cohesion: 0.31
Nodes (8): computeUnaidedProduction(), isUnaided(), NOW, pair(), review(), UnaidedProductionStats, CardDirection, ReviewRecord
...
Cohesion: 0.08
Nodes (34): ADVANCED_CONVERSATION_FLOOR, average(), deriveListeningStage(), deriveProgressionState(), deriveReadingWritingStage(), deriveSpeakingStage(), FAMILIAR_TOPICS, FamiliarTopic (+26 more)

### Community 238 - "MistakeStep.tsx"
Cohesion: 0.14
Nodes (27): Notice(), NoticeProps, toneClass, Spinner(), DeckGenerationError, evaluateCorrectionText(), generateCorrectionDeck(), transcribeAudio() (+19 more)
...
### Community 240 - "2. The card pipeline — architecture"
Cohesion: 0.29
...
### Community 243 - "19. Prioritized roadmap"
Cohesion: 0.40
...
## Knowledge Gaps
- **890 isolated node(s):** `eslintConfig`, `nextConfig`, `name`, `version`, `private` (+885 more)
...
- **Why does `ErrorEvent` connect `W5 Validation Protocol` to `Demo Fixture Data`, `audio.ts`, `First-Run Activation`, `Learn Audio Generation Script`, `route.integration.test.ts`, `Local Store Repository`, `Ingestion API Routes`, `Discover & Provider Selection`, `Plan Generation API`, `SRS Analytics Dashboard`, `Card Export API`, `Study Session Modes`, `Conversation Providers`, `Lesson View UI`, `effort.ts`, `Semantic Card Dedup`, `C1 Phase Proposal`, `linux`, `audio.ts`, `Learning Rubrics`, `MistakeStep.tsx`, `inputOutput.integration.test.ts`, `audioMetadata.ts`, `ReviewRecord`?**
